...
################################################################################
[Defines]
  PLATFORM_NAME                  = QemuArmVirtPkg
  PLATFORM_GUID                  = 37d7e986-f7e9-45c2-8067-e371421a626c
  PLATFORM_VERSION               = 0.1
  DSC_SPECIFICATION              = 0x00010005
  OUTPUT_DIRECTORY               = Build/QemuArmVirtPkg
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE|NOOPT
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = QemuArmVirtPkg/QemuArmVirtPkg.fdf
...
!include NetworkPkg/NetworkLibs.dsc.inc
  ...
  QemuFwCfgLib|QemuPkg/Library/QemuFwCfgLib/QemuFwCfgLibMmio.inf
  PciHostBridgeUtilityLib|QemuPkg/Library/PciHostBridgeUtilityLib/PciHostBridgeUtilityLib.inf
  PciPcdProducerLib|QemuArmVirtPkg/Library/FdtPciPcdProducerLib/FdtPciPcdProducerLib.inf
  VirtNorFlashPlatformLib|QemuArmVirtPkg/Library/QemuVirtNorFlashLib/QemuVirtNorFlashLib.inf
  ...
  PciExpressLib|QemuArmVirtPkg/Library/BaseCachingPciExpressLib/BaseCachingPciExpressLib.inf
  ...
  PciHostBridgeLib|QemuArmVirtPkg/Library/FdtPciHostBridgeLib/FdtPciHostBridgeLib.inf
  ...
  MsPlatformDevicesLib|QemuArmVirtPkg/Library/MsPlatformDevicesLibQemuArmVirt/MsPlatformDevicesLib.inf
  ...
  UiRectangleLib           |MsGraphicsPkg/Library/BaseUiRectangleLib/BaseUiRectangleLib.inf
  PlatformThemeLib         |QemuPkg/Library/PlatformThemeLib/PlatformThemeLib.inf
...
!endif
  ...
  gEmbeddedTokenSpaceGuid.PcdMemoryTypeEfiACPIMemoryNVS|0x78
...
!endif
  ...
  # TODO: Make this together with other STMM PCDs
...
[PcdsFixedAtBuild.common]
  ...
  # TPM2 support
  #
  gEfiSecurityPkgTokenSpaceGuid.PcdTpmBaseAddress|0x40200000
  gEfiSecurityPkgTokenSpaceGuid.PcdTpmMaxAddress|0x40204FFF
...
[PcdsFixedAtBuild.AARCH64]
  ...
  # partition manifest.
  #
  gArmTokenSpaceGuid.PcdMmBufferBase|0xbfe00000

  #
  # Advanced Logger Base Address
  #
  gAdvLoggerPkgTokenSpaceGuid.PcdAdvancedLoggerBase|0x40210000

[PcdsDynamicDefault.common]

  ## PL031 RealTimeClock
  gArmPlatformTokenSpaceGuid.PcdPL031RtcBase|0x09010000
...
!if $(BUILD_UNIT_TESTS) == TRUE
  ...
  !endif
  # UefiTestingPkg/FunctionalSystemTests/MemoryAttributeProtocolFuncTestApp/MemoryAttributeProtocolFuncTestApp.inf # PROTOCOL NOT AVAILABLE ON ARM-Virt
  ...
  # MmSupervisorPkg/Test/MmPagingAuditTest/UEFI/MmPagingAuditApp.inf # NOT APPLICABLE TO ARM-Virt
  # MmSupervisorPkg/Test/MmSupvRequestUnitTestApp/MmSupvRequestUnitTestApp.inf # NOT APPLICABLE TO ARM-Virt
  ...
  # UefiTestingPkg/AuditTests/DMAProtectionAudit/UEFI/DMAIVRSProtectionUnitTestApp.inf # NOT APPLICABLE TO ARM-Virt
  ...
  # UefiTestingPkg/FunctionalSystemTests/ExceptionPersistenceTestApp/ExceptionPersistenceTestApp.inf # NOT APPLICABLE TO ARM-Virt
  ...
  # UefiTestingPkg/FunctionalSystemTests/MemoryProtectionTest/App/SmmMemoryProtectionTestApp.inf # NOT APPLICABLE TO ARM-Virt
  # UefiTestingPkg/FunctionalSystemTests/SmmPagingProtectionsTest/Smm/SmmPagingProtectionsTestSmm.inf # NOT APPLICABLE TO ARM-Virt
  ...
  # UefiTestingPkg/FunctionalSystemTests/MemoryProtectionTest/Driver/SmmMemoryProtectionTestDriver.inf # NOT APPLICABLE TO ARM-Virt
...
[BuildOptions]
  ...
  *_CLANGPDB_AARCH64_GENFW_FLAGS   = --keepexceptiontable
  ...
  #
  *_CLANGPDB_*_CC_FLAGS = -DDISABLE_NEW_DEPRECATED_INTERFACES -mbranch-protection=standard

  # TODO: Figure out this, without this, the WSL build will not be able to resolve the path
  *_CLANGPDB_*_DLINK_FLAGS = /PDBALTPATH:%_PDB%
