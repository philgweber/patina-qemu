# @file
# Script to Build QemuArmVirt host-based unit tests.
#
...
PLATFORM_TEST_DSC = 'QemuArmVirtPkg/Test/QemuArmVirtPkgHostTest.dsc'
PLATFORM_DSC = 'QemuArmVirtPkg/QemuArmVirtPkg.dsc'
...
class TestManager(BuildSettingsManager, UefiBuilder):
    ...
    def GetActiveScopes(self):
        return ('qemu', 'qemuarmvirt', 'edk2-build', 'cibuild', 'host-based-test')
